var $animation_elements=$(".animation-element"),$window=$(window);function check_if_in_view(){var e=$window.height(),t=$window.scrollTop(),i=t+e;$.each($animation_elements,(function(){var e=$(this),s=e.outerHeight(),a=e.offset().top;a+s>=t&&a<=i?e.addClass("in-view"):e.removeClass("in-view")}))}$window.on("scroll resize",check_if_in_view),$window.trigger("scroll"),$("#carouselExample").on("slide.bs.carousel",(function(e){var t=$(e.relatedTarget).index(),i=$(".carousel-item").length;if(t>=i-3)for(var s=4-(i-t),a=0;a<s;a++)"left"==e.direction?$(".carousel-item").eq(a).appendTo(".carousel-inner"):$(".carousel-item").eq(0).appendTo(".carousel-inner")})),function(e){var t,i=[],s=!1,a=!1,r={interval:250,force_process:!1},n=e(window);function o(){a=!1;for(var s=0;s<i.length;s++){var r=e(i[s]).filter((function(){return e(this).is(":appeared")}));if(r.trigger("appear",[r]),t){var n=t.not(r);n.trigger("disappear",[n])}t=r}}e.expr[":"].appeared=function(t){var i=e(t);if(!i.is(":visible"))return!1;var s=n.scrollLeft(),a=n.scrollTop(),r=i.offset(),o=r.left,l=r.top;return l+i.height()>=a&&l-(i.data("appear-top-offset")||0)<=a+n.height()&&o+i.width()>=s&&o-(i.data("appear-left-offset")||0)<=s+n.width()},e.fn.extend({appear:function(t){var n=e.extend({},r,t||{}),l=this.selector||this;if(!s){var d=function(){a||(a=!0,setTimeout(o,n.interval))};e(window).scroll(d).resize(d),s=!0}return n.force_process&&setTimeout(o,n.interval),i.push(l),e(l)}}),e.extend({force_appear:function(){return!!s&&(o(),!0)}})}(jQuery),
/*!
